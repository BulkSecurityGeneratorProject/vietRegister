...
describe('Service Tests', () => {
    ...
    describe('PratiquantMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PratiquantMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pratiquants';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PratiquantMySuffix', () => {
